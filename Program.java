public class Program {
    ...
    private final int polarBearStarvationEngergyThreshold = 150;
    ...
    public void PolarBearHunts() {
        ...
        switch (penguinNumber) {
            case 1:
                if (IsPenguinOneAlive()) PolarBearHuntsPenguinOne();
                break;

            case 2:
                if (IsPenguinTwoAlive()) PolarBearHuntsPenguinTwo();
                break;

            case 3:
                if (IsPenguinThreeAlive()) PolarBearHuntsPenguinThree();
                break;
    ...
    public void ShowWhatDoYouWant(String cmd) {
        String msg = MessageFormat.format("The Zoo caretaker does not understand '{0}'.", cmd);
    ...
    public void FeedPenguin() {
        ...
        switch (penguinNumber) {
            case 1:
                if (IsPenguinOneAlive()) FeedPenguinOne(fish);
                break;

            case 2:
                if (IsPenguinTwoAlive()) FeedPenguinTwo(fish);
                break;

            case 3:
                if (IsPenguinThreeAlive()) FeedPenguinThree(fish);
                break;
    ...
    public void ShowStatus() {
        ...
        switch (numberOfPinguins) {
            case 3:
                penguinMsg = "Three penguins and a polar bear.";
                break;
            case 2:
                penguinMsg = "Two penguins and a polar bear.";
                break;
            case 1:
                penguinMsg = "One penguin and a polar bear.";
                break;
            case 0:
                penguinMsg = "Just a lonely dead? polar bear.";
                break;
        }
